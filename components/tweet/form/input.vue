  ...
  <div class="max-w-xl mx-auto my-2 mb-12 bg-gray-200 rounded-md py-2 px-2">
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          v-model="text"
          class="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 focus:ring-0"
    ...
    <!-- Icons -->
      <div class="flex w-full text-white">
        <div class="p-2 text-gray-600 rounded-full cursor-pointer bg-blue-50" @click="handleImageClick">
